      ...
      <div className="auth-box" onClick={e => e.stopPropagation()}>
        ...
        <button className="auth-btn-google" onClick={handleGoogleLogin} disabled={loading}>
          <svg className="auth-google-icon" viewBox="0 0 24 24" width="20" height="20">
            ...
            <path fill="#FBBC05" d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.06H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.94l2.85-2.22c-.62-.06-1.19-.38-1.67-.79z"/>
